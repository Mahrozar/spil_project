...
class LetterSubmission extends Model
{
    ...
    public function badgeClass(): string
    {
        return match ($this->status) {
            self::STATUS_APPROVE => 'inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800',
            self::STATUS_ON_PROGRESS => 'inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800',
            self::STATUS_REJECTED => 'inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800',
