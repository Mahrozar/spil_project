            ...
            <div class="hidden md:flex items-center space-x-1">
                ...
                <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-200" 
                        ...
                        <a href="{{ route('layanan.pelaporan-fasilitas') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-primary transition-colors duration-150">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 mr-2 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
        ...
        <div id="mobile-menu" class="hidden md:hidden mt-4 space-y-3 pb-4 border-t border-gray-200 pt-4">
            ...
            <div x-data="{ open: false }" class="pl-2">
                ...
                <div x-show="open" class="space-y-2 pl-4 border-l border-gray-200 mt-2">
                    ...
                    <a href="{{ route('layanan.pelaporan-fasilitas') }}" class="block text-gray-600 hover:text-primary py-1">
